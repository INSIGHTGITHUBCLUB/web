  ...
  <div class="self">
    <div class="detail">
      <div class="detail-left">
        ...
        <h1 class="post-title">Welcome to the Self-Introduction!</h1>
        <p class="in">in welcome post</p>
        <div class="post-content">
          <p>Dear learners:</p>
          <p>Hi!</p>
          <p>
            Please welcome each other and spend some time to introduce yourselves to the community by posting a comment!
          </p>
